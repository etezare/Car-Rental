...
public class Booking {
    ...
    @NotBlank(message = "Please enter booking date")
    private LocalDate bookingDate;

    @Column(name = "start_date")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @NotBlank(message = "Please enter booking start date and time")
    private LocalDate startDate;

    @Column(name = "end_date")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @NotBlank(message = "Please enter booking end date and time")
    ...
    @NotBlank(message = "Please enter user first name")
...
//	private User user;
    ...
    public Booking(@NotBlank String referenceNumber, @NotBlank(message = "Please enter booking date") LocalDate bookingDate,
                   @NotBlank(message = "Please enter booking start date and time") LocalDate startDate,
                   @NotBlank(message = "Please enter booking end date and time") LocalDate endDate, Double totalPrice,
                   @NotBlank(message = "Please enter user first name") String firstName,
